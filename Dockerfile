...
RUN wget https://github.com/coconut-island/CNIFaceResource/raw/main/models/genderage.onnx -O /CNIFace/models/genderage.onnx
...
RUN cd /CNIFace && python3 ./convert_model/from_onnx_genderage.py
