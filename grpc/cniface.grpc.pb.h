...
class DetectWithMaskService final {
 public:
  static constexpr char const* service_full_name() {
    return "cniface.DetectWithMaskService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::cniface::DetectWithMaskResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>> Asyncdetect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>>(AsyncdetectRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>> PrepareAsyncdetect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>>(PrepareAsyncdetectRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      virtual void detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>* AsyncdetectRaw(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::cniface::DetectWithMaskResponse>* PrepareAsyncdetectRaw(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    ::grpc::Status detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::cniface::DetectWithMaskResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>> Asyncdetect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>>(AsyncdetectRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>> PrepareAsyncdetect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>>(PrepareAsyncdetectRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response, std::function<void(::grpc::Status)>) override;
      void detect(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>* AsyncdetectRaw(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::cniface::DetectWithMaskResponse>* PrepareAsyncdetectRaw(::grpc::ClientContext* context, const ::cniface::DetectWithMaskRequest& request, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_detect_;
  };
  static std::unique_ptr<Stub> NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status detect(::grpc::ServerContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response);
  };
  template <class BaseClass>
  class WithAsyncMethod_detect : public BaseClass {
   private:
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status detect(::grpc::ServerContext* /*context*/, const ::cniface::DetectWithMaskRequest* /*request*/, ::cniface::DetectWithMaskResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void Requestdetect(::grpc::ServerContext* context, ::cniface::DetectWithMaskRequest* request, ::grpc::ServerAsyncResponseWriter< ::cniface::DetectWithMaskResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_detect<Service > AsyncService;
  ...
  class WithCallbackMethod_detect : public BaseClass {
   ...
   public:
    WithCallbackMethod_detect() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::cniface::DetectWithMaskRequest, ::cniface::DetectWithMaskResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::cniface::DetectWithMaskRequest* request, ::cniface::DetectWithMaskResponse* response) { return this->detect(context, request, response); }));}
    void SetMessageAllocatorFor_detect(
        ::grpc::MessageAllocator< ::cniface::DetectWithMaskRequest, ::cniface::DetectWithMaskResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::cniface::DetectWithMaskRequest, ::cniface::DetectWithMaskResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_detect() override {
      BaseClassMustBeDerivedFromService(this);
    ...
    virtual ::grpc::ServerUnaryReactor* detect(
      ::grpc::CallbackServerContext* /*context*/, const ::cniface::DetectWithMaskRequest* /*request*/, ::cniface::DetectWithMaskResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_detect<Service > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  class WithStreamedUnaryMethod_detect : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_detect() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::cniface::DetectWithMaskRequest, ::cniface::DetectWithMaskResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::cniface::DetectWithMaskRequest, ::cniface::DetectWithMaskResponse>* streamer) {
                       return this->Streameddetect(context,
                         streamer);
                  }));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streameddetect(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::cniface::DetectWithMaskRequest,::cniface::DetectWithMaskResponse>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_detect<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_detect<Service > StreamedService;
